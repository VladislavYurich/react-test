...
import { PrintElements } from '../../typings'
import { printBtnClick } from '../../utils'
...
const OrderDetail = (): JSX.Element => {
  ...
  const signRefAct = useRef<any>(null)
  const btnsRefAct = useRef<any>(null)
  const areaCommentRef = useRef<any>(null)
  const btnsRefComment = useRef<any>(null)
  ...
  const testFunc = (
    ...
    e.preventDefault()
    if (sign) {
      sign.current.style.display = 'block'
    } else {
      area.current.style.display = 'none'
    }
    btns.current!.style.display = 'none'
    handlePrint(null, () => content.current)
    if (sign) {
      sign.current.style.display = 'none'
    } else {
      area.current.style.display = 'block'
    }
    btns.current!.style.display = 'flex'
  }
  return loading ? (
          ...
          <CCard className="px-0">
            ...
            >
              ...
              >
                ...
                <div className="btnPrintWrapper" ref={btnsRef}>
                  <button
                    className="btnPrint"
                    onClick={() =>
                      printBtnClick(
                        'print',
                        PrintElements.requestCard,
                        btnsRef,
                        signRef,
                      )
                    }
            ...
            <CCard className="mt-4 px-0">
              ...
              >
                ...
                >
                  ...
                  <div className="btnPrintWrapper" ref={btnsRefAct}>
                    <button
                      className="btnPrint"
                      onClick={() =>
                        printBtnClick(
                          'print',
                          PrintElements.documentCard,
                          btnsRefAct,
                          signRefAct,
                        )
                      }
          ...
          <CCard className="mt-4 px-0">
            ...
            >
              ...
              >
                ...
                <div className="btnPrintWrapper" ref={btnsRefComment}>
                  <button
                    className="btnPrint"
                    onClick={() =>
                      printBtnClick(
                        'print',
                        PrintElements.commentsCard,
                        btnsRefComment,
                        undefined,
                        areaCommentRef,
                      )
