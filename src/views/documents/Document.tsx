    ...
    <CContainer>
      ...
      <div className="btnPrintWrapper" ref={btnsRef}>
        <button
          className="btnPrint"
          onClick={() =>
            printBtnClick('print', PrintElements.opentDocument, btnsRef)
          }
        >
          Печать
        </button>
        <button
          className="btnPrint"
          onClick={() =>
            printBtnClick('save', PrintElements.opentDocument, btnsRef)
          }
        >
          Скачать
        </button>
